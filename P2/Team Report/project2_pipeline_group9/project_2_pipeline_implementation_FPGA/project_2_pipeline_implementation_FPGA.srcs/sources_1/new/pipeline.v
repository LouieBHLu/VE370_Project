module pipeline_processor(reg_zero, at, v0, v1, a0, a1, a2, a3, s0, s1,
         s2, s3, s4, s5, s6, s7, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, k0, k1, gp, sp, fp, ra, pc,
          clk, reset);
input clk, reset;
output [31:0] pc, reg_zero, at, v0, v1, a0, a1, a2, a3, s0, s1,
...
register regpc(PC1,PCIN,clk,enable, reset);
adder adder1(PC2, PC1, 4);
inst_mem instruction_memory(I1, PC1, reset);
...
register_file register_file1(reg_zero, at, v0, v1, a0, a1, a2, a3, s0, s1,
         s2, s3, s4, s5, s6, s7, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, k0, k1, gp, sp, fp, ra, 
...
MemRead_ID_EX, MemRead_DM, inst , I9, I10, RegWrite_o, regwrite1, equal, clk, reset);
...
data_mem date_memory_1(M0, memwrite, MemRead_DM, A1, R10, clk, reset);
